...
const ICONS: Record<string, (p: IconProps) => JSX.Element> = {
  ...
  intake: ({ className }) => (
    <Svg className={className}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><path d="M14 2v6h6" /><path d="M16 13H8" /><path d="M16 17H8" /><path d="M10 9H8" /></Svg>
  ),
  portals: ({ className }) => (
  ...
  'client-intake': ({ className }) => (
    <Svg className={className}><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" /><rect x="8" y="2" width="8" height="4" rx="1" /></Svg>
  ),
  marketing: ({ className }) => (
